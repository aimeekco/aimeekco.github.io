...
const projects = [
  ...
  { image: sushi, demo: geolocation, title: 'Duolingo Half-Life Regression', description: 'Brief description of Project 6',
    longdescription: 'hellooo' },
  { image: sushi, demo: geolocation, title: 'Flight Delay Prediction - 2023 5C Datathon', description: 'Brief description of Project 6',
